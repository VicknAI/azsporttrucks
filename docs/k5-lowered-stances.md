...
## Rear roof plane correction

The top-on, laying-frame rear-quarter preview has a malformed hardtop roof plane. The correction is limited to that combination in both artwork families: 1970 for the 1969/1970 selections and 1972 for 1971/1972. White, black and body-color hardtops share the corrected geometry. Top-off previews, other heights and views, pictured-height artwork, and all saved configuration choices retain their existing sources and behavior.

The affected six-layer paint packs use `chevrolet-k5-{1970|1972}-street-stance-v4/top-on/frame/rear-quarter/`; matching Torq Thrust II and Rocket Attack scenes use `chevrolet-k5-{1970|1972}-{torq|rocket-attack}-v5/top-on/{18|20}/frame/rear-quarter.png`. This versions 12 paint-pack PNGs and eight wheel scenes. Other lowered paint packs remain v3 and alternate-wheel scenes remain v4. Authoring and verification are retained in workspace `assets/k5-roof-plane/`.

All 50 repository tests pass, including the conditional versions, hardtop colors, all wheel choices, saved/shared builds, exports and private quote reviews. Independent comparison with 5947bf0 preserves all 31 defaults, 2,632 configurations and 10,288 unaffected renders; the 240 targeted renders differ only by the expected artwork URLs. Publish and verify the new website assets before deploying the quote Worker so private reviews can load the corrected packs.
