...
export function renderSvg(
  ...
  if (a.studio) return renderStudio(c, a.studio, prefix);
 ...
 ${layer('roof', asset(k5 && c.roof === 'Top off' ? a.topOffInterior : a.roof, roof + (!k5 && c.contrastRoof ? `<path d="${g.cab}" fill="${roofColor}" clip-path="inset(0 0 65% 0)"/>` : '')))}
