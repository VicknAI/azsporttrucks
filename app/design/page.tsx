      ...
      <section className="designer-guide" aria-labelledby="designer-guide-title">
        ...
        <div className="designer-guide-columns">
          <div>
            ...
            <p>Choose an earlier K10 as 1967, 1968, 1969–1970, or 1971–1972. The paired years share the same preview artwork. Square-body K10 choices include 1973–1974 Cheyenne Super, 1975–1976 Scottsdale, and 1983–1984 Silverado-style previews. The Silverado group shows the later hood and fenders, stacked rectangular headlights, and a navy/silver reference paint scheme. All three groups offer solid and two-tone paint, chrome molding, and wheel options. Their contrasting cab treatment colors the roof and cab back while the door window frames retain the body color. On 1967–1972 C10 and K10 pickups, contrasting cab color covers the roof and pillars. K5 options include different hardtop colors and a top-off view.</p>
          </div>
          <div>
