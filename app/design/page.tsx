      ...
      <section className="designer-guide" aria-labelledby="designer-guide-title">
        ...
        <div className="designer-guide-columns">
          <div>
            ...
            <p>The 1979 Bronco offers a white, black, or body-color rear hardtop and a Top off option. The fixed steel front cab stays body color. Try its blue/white reference paint or your own colors, with black vinyl upholstery and the pictured lifted stance. Compare the original white wheels with polished or black American Racing Baja wheels and raw-machined KMC Impact Monoblock or Beadlock wheels.</p>
          </div>
          <div>
