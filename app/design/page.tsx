      ...
      <section className="designer-guide" aria-labelledby="designer-guide-title">
        ...
        <div className="designer-guide-columns">
          <div>
            ...
            <p>Choose an earlier K10 as 1967, 1968, 1969–1970, or 1971–1972. The paired years share the same preview artwork. Square-body K10 choices include 1973–1974 Cheyenne Super, 1975–1976 Scottsdale, 1977–1979 Custom Deluxe, and 1983–1984 and 1985–1987 Silverado-style previews. The 1977–1979 group pairs round headlights and a dark grille with a tan/white reference scheme. The later Silverado groups show the angular hood and fenders and stacked rectangular headlights, with a grille specific to each group. Try the navy/silver 1983–1984 reference scheme or the solid black 1985–1987 look. All five groups offer solid and two-tone paint, chrome molding, and wheel options. Their contrasting cab treatment colors the roof and cab back while the door window frames retain the body color. The 1987 four-wheel-drive truck was designated V10; it is included in the 1985–1987 group here. On 1967–1972 C10 and K10 pickups, contrasting cab color covers the roof and pillars. K5 options include different hardtop colors and a top-off view.</p>
          </div>
          <div>
